        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="99.90" name="price" value="{{ $product->price }}">
                </div>
                <div class="form-group">
                    <label for=""><strong>Details</strong></label>
                    <textarea class="form-control" placeholder="Details" name="details">{{ $product->details }}</textarea>
                </div>

                <div class="form-check">
                    <input class="form-check-input" type="radio" name="publish" value="1"  @if(data_get($product,'publish') == 1) checked @endif>
                    <label class="form-check-label" for="">
                        Yes
                    </label>
                  </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="publish" value="2" @if(data_get($product,'publish') == 2) checked @endif>
                    <label class="form-check-label" for="">
                        No
                    </label>
                </div>
